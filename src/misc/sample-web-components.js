...
const an = 1, cn = 2, _t = "[", vt = "[!", pt = "]", ge = {}, y = /* @__PURE__ */ Symbol(), Ve = !1;
var hn = Array.isArray, dn = Array.prototype.indexOf, _n = Array.from, Ce = Object.keys, Ne = Object.defineProperty, ce = Object.getOwnPropertyDescriptor, vn = Object.prototype, pn = Array.prototype, $n = Object.getPrototypeOf, lt = Object.isExtensible;
function gn(e) {
...
const w = 2, Oe = 4, Ie = 8, gt = 1 << 24, K = 16, le = 32, ee = 64, Je = 128, N = 512, x = 1024, S = 2048, z = 4096, J = 8192, H = 16384, Xe = 32768, Pe = 65536, ut = 1 << 17, yt = 1 << 18, ue = 1 << 19, yn = 1 << 20, se = 32768, He = 1 << 21, Ze = 1 << 22, X = 1 << 23, Be = /* @__PURE__ */ Symbol("$state"), mn = /* @__PURE__ */ Symbol("legacy props"), ae = new class extends Error {
...
function nt(e) {
  (e.f & N) !== 0 || e.deps === null ? b(e, x) : b(e, z);
}
function At(e) {
  if (e !== null)
    for (const t of e)
      (t.f & w) === 0 || (t.f & se) === 0 || (t.f ^= se, At(
        /** @type {Derived} */
        t.deps
      ));
}
function Rt(e, t, n) {
  (e.f & S) !== 0 ? t.add(e) : (e.f & z) !== 0 && n.add(e), At(e.deps), b(e, x);
}
const Te = /* @__PURE__ */ new Set();
let g = null, O = null, C = [], qe = null, Ue = !1, pe = !1;
class P {
  committed = !1;
  /**
  ...
  process(t) {
    ...
    for (const r of t)
      this.#f(r, n, i);
    this.is_fork || this.#o(), this.is_deferred() ? (this.#u(i), this.#u(n)) : (g = null, ot(i), ot(n), this.#s?.resolve()), O = null;
  }
  /**
  ...
  #f(t, n, i) {
    ...
    for (var r = t.first, s = null; r !== null; ) {
      var f = r.f, l = (f & (le | ee)) !== 0, u = l && (f & x) !== 0, o = u || (f & J) !== 0 || this.skipped_effects.has(r);
      if (!o && r.fn !== null) {
        l ? r.f ^= x : s !== null && (f & (Oe | Ie | gt)) !== 0 ? s.b.defer_effect(r) : (f & Oe) !== 0 ? n.push(r) : Ee(r) && ((f & K) !== 0 && this.#r.add(r), me(r));
        var a = r.first;
        if (a !== null) {
          r = a;
          continue;
   ...
   */
  capture(t, n) {
    n !== y && !this.previous.has(t) && this.previous.set(t, n), (t.f & X) === 0 && (this.current.set(t, t.v), O?.set(t, t.v));
  }
  activate() {
    g = this, this.apply();
  }
  deactivate() {
    g === this && (g = null, O = null);
  }
  flush() {
  ...
  #a() {
    ...
    this.committed = !0, Te.delete(this);
  }
  /**
   *
...
function Ct(e) {
  ...
  try {
    for (var n; ; ) {
      if (Dn(), C.length === 0 && (g?.flush(), C.length === 0))
...
function ot(e) {
  ...
  if (t !== 0) {
    for (var n = 0; n < t; ) {
      var i = e[n++];
      if ((i.f & (H | J)) === 0 && Ee(i) && (V = /* @__PURE__ */ new Set(), me(i), i.deps === null && i.first === null && i.nodes === null && (i.teardown === null && i.ac === null ? zt(i) : i.fn = null), V?.size > 0)) {
        Z.clear();
        for (const r of V) {
          if ((r.f & (H | J)) !== 0) continue;
          const s = [r];
          let f = r.parent;
          for (; f !== null; )
            V.has(f) && (V.delete(f), s.push(f)), f = f.parent;
  ...
  if (!n.has(e) && (n.add(e), e.reactions !== null))
    for (const r of e.reactions) {
      ...
      (s & w) !== 0 ? Ot(
        ...
        n,
        i
      ) : (s & (Ze | K)) !== 0 && (s & S) === 0 && Pt(r, t, i) && (b(r, S), Q(
        /** @type {Effect} */
        r
      ));
    }
...
class qn {
  ...
  constructor(t, n, i) {
    ...
    v.b, this.is_pending = !!this.#i.pending, this.#s = rr(() => {
      if (v.b = this, m) {
        const s = this.#t;
        et(), /** @type {Comment} */
  ...
  #b() {
    ...
    t && (this.#n = te(() => t(this.#e)), P.enqueue(() => {
      var n = this.#g();
      this.#r = this.#p(() => (P.ensure(), te(() => this.#l(n)))), this.#c > 0 ? this.#$() : (ke(
        /** @type {Effect} */
        this.#n,
        () => {
          this.#n = null;
  ...
  #p(t) {
    var n = v, i = _, r = M;
    j(this.#s), T(this.#s), he(this.#s.ctx);
    try {
      return t();
    } catch (s) {
      return kt(s), null;
  ...
  #$() {
    ...
    this.#r !== null && (this.#u = document.createDocumentFragment(), this.#u.append(
      /** @type {TemplateNode} */
      this.#o
    ), fr(this.#r, this.#u)), this.#n === null && (this.#n = te(() => t(this.#e)));
  }
  /**
  ...
  #y(t) {
    ...
    if (this.#c += t, this.#c === 0) {
      ...
      for (const n of this.#v)
        b(n, z), Q(n);
      this.#_.clear(), this.#v.clear(), this.#n && ke(this.#n, () => {
        this.#n = null;
  ...
  update_pending_count(t) {
    this.#y(t), this.#a += t, this.#h && Fe(this.#h, this.#a);
  }
  get_effect_pending() {
    return this.#m(), A(
      /** @type {Source<number>} */
  ...
  error(t) {
    ...
    if (this.#d || !n && !i)
      throw t;
    this.#r && (F(this.#r), this.#r = null), this.#n && (F(this.#n), this.#n = null), this.#f && (F(this.#f), this.#f = null), m && (G(
      /** @type {TemplateNode} */
      this.#t
    ), Rn(), G(Cn()));
    var r = !1, s = !1;
...
function Bn() {
  var e = v, t = _, n = M, i = g;
  return function(s = !0) {
    j(e), T(t), he(n), s && i?.activate();
  };
}
function De() {
  j(null), T(null), he(null);
}
// @__NO_SIDE_EFFECTS__
function Dt(e) {
  ...
  return nr(() => {
    ...
    try {
      Promise.resolve(e()).then(o.resolve, o.reject).then(() => {
        a === g && a.committed && a.deactivate(), De();
      });
    } catch (h) {
      o.reject(h), De();
    }
...
function Mt(e) {
  ...
  fe || (O !== null ? (it() || g?.is_fork) && O.set(e, t) : nt(e));
}
...
function Fe(e, t) {
  if (!e.equals(t)) {
    ...
    e.wv = Xt(), It(e, S), v !== null && (v.f & x) !== 0 && (v.f & (le | ee)) === 0 && (R === null ? ur([e]) : R.push(e)), !i.is_fork && Ge.size > 0 && !Lt && Gn();
  }
  return t;
}
function Gn() {
  ...
  if (n !== null)
    for (var i = n.length, r = 0; r < i; r++) {
      ...
      if (l && b(s, t), (f & w) !== 0) {
        ...
        O?.delete(u), (f & se) === 0 && (f & N && (s.f |= se), It(u, z));
      } else l && ((f & K) !== 0 && V !== null && V.add(
        /** @type {Effect} */
        s
      ), Q(
        /** @type {Effect} */
...
function ve(e) {
  ...
  if (t !== vn && t !== pn)
    return e;
  var n = /* @__PURE__ */ new Map(), i = hn(e), r = /* @__PURE__ */ B(0), s = ie, f = (l) => {
    if (ie === s)
      return l();
    var u = _, o = ie;
    T(null), ht(s);
  ...
  return i && n.set("length", /* @__PURE__ */ B(
    /** @type {any[]} */
    e.length
  )), new Proxy(
    /** @type {any} */
    e,
    {
      ...
      has(l, u) {
        ...
        if (o !== void 0 || v !== null && (!a || ce(l, u)?.writable)) {
          o === void 0 && (o = f(() => {
            var c = a ? ve(l[u]) : y, h = /* @__PURE__ */ B(c);
            return h;
          }), n.set(u, o));
          var d = A(o);
          if (d === y)
      ...
      set(l, u, o, a) {
        ...
        if (i && u === "length")
          ...
          d.v; h += 1) {
            var $ = n.get(h + "");
            $ !== void 0 ? I($, y) : h in l && ($ = f(() => /* @__PURE__ */ B(y)), n.set(h + "", $));
          }
        if (d === void 0)
          (!c || ce(l, u)?.writable) && (d = f(() => /* @__PURE__ */ B(void 0)), I(d, ve(o)), n.set(u, d));
        else {
          c = d.v !== y;
          var L = f(() => ve(o));
          I(d, L);
        ...
        if (Y?.set && Y.set.call(a, o), !c) {
          if (i && typeof u == "string") {
            var ft = (
              /** @type {Source<number>} */
              n.get("length")
            ), Ye = Number(u);
            Number.isInteger(Ye) && Ye >= ft.v && I(ft, Ye + 1);
          }
          $e(r);
        }
        return !0;
...
function Bt(e, t) {
  ...
  var n = /* @__PURE__ */ _e(p);
  return n === null && (n = p.appendChild(be())), G(n), n;
}
function Kn(e, t = !1) {
  if (!m) {
    var n = /* @__PURE__ */ _e(e);
...
function zn(e, t = 1, n = !1) {
  ...
  if (n && i?.nodeType !== mt) {
    var s = be();
    return i === null ? r?.after(s) : i.before(s), G(s), s;
  }
  return G(i), i;
}
function Wn(e) {
...
function q(e, t, n) {
  ...
  (s.f & ue) === 0 && (s = s.first, (e & K) !== 0 && (e & Pe) !== 0 && s !== null && (s.f |= Pe)), s !== null && (s.parent = i, i !== null && Jn(s, i), _ !== null && (_.f & w) !== 0 && (e & ee) === 0)) {
    var f = (
      /** @type {Derived} */
      _
    );
...
function F(e, t = !0) {
  var n = !1;
  (t || (e.f & yt) !== 0) && e.nodes !== null && e.nodes.end !== null && (sr(
    e.nodes.start,
    /** @type {TemplateNode} */
    e.nodes.end
  ), n = !0), Kt(e, t && !n), Le(e, 0), b(e, H);
  ...
  Gt(e);
  var r = e.parent;
  r !== null && r.first !== null && zt(e), e.next = e.prev = e.teardown = e.ctx = e.deps = e.fn = e.nodes = e.ac = null;
}
function sr(e, t) {
  for (; e !== null; ) {
...
function Wt(e, t, n) {
  if ((e.f & J) === 0) {
    ...
    for (var r = e.first; r !== null; ) {
      var s = r.next, f = (r.f & Pe) !== 0 || // If this is a branch effect without a block effect parent,
...
let U = null;
function lr(e) {
  _ !== null && (U === null ? U = [e] : U.push(e));
}
let E = null, k = 0, R = null;
function ur(e) {
  R = e;
}
let Jt = 1, ye = 0, ie = ye;
...
function Qt(e) {
  var t = E, n = k, i = R, r = _, s = U, f = M, l = D, u = ie, o = e.f;
  E = /** @type {null | Value[]} */
  null, k = 0, R = null, _ = (o & (le | ee)) === 0 ? e : null, U = null, he(e.ctx), D = !1, ie = ++ye, e.ac !== null && (Vt(() => {
    e.ac.abort(ae);
  }), e.ac = null);
  try {
    e.f |= He;
    ...
    if (E !== null) {
      var h;
      if (Le(e, k), c !== null && k > 0)
        for (c.length = k + E.length, h = 0; h < E.length; h++)
          c[k + h] = E[h];
      else
        e.deps = c = E;
      if (it() && (e.f & N) !== 0)
    ...
    } else c !== null && k < c.length && (Le(e, k), c.length = k);
    if (Tt() && R !== null && !D && c !== null && (e.f & (w | z | S)) === 0)
    ...
    e.f ^= He, E = t, k = n, R = i, _ = r, U = s, he(f), D = l, ie = u;
  }
}
function or(e, t) {
  let n = t.reactions;
  ...
  (E === null || !E.includes(t))) {
    ...
    (s.f & N) !== 0 && (s.f ^= N, s.f &= ~se), nt(s), Ft(s), Le(s, 0);
  }
}
function Le(e, t) {
  var n = e.deps;
...
function me(e) {
  ...
  if ((t & H) === 0) {
    ...
    v = e, re = !0;
    try {
      (t & (K | gt)) !== 0 ? ir(e) : Kt(e), Gt(e);
      var r = Qt(e);
      e.teardown = typeof r == "function" ? r : null, e.wv = Jt;
      var s;
      Ve && Pn && (e.f & S) !== 0 && e.deps;
    } finally {
      re = i, v = n;
    }
  }
...
function A(e) {
  var t = e.f, n = (t & w) !== 0;
  if (_ !== null && !D) {
    var i = v !== null && (v.f & H) !== 0;
    if (!i && !U?.includes(e)) {
      var r = _.deps;
      if ((_.f & He) !== 0)
        e.rv < ye && (e.rv = ye, E === null && r !== null && r[k] === e ? k++ : E === null ? E = [e] : E.includes(e) || E.push(e));
      else {
        (_.deps ??= []).push(e);
        var s = e.reactions;
  ...
  if (n) {
    ...
    if (fe) {
      var l = f.v;
      return ((f.f & x) === 0 && f.reactions !== null || tn(f)) && (l = rt(f)), Z.set(f, l), l;
    }
    var u = (f.f & N) === 0 && !D && _ !== null && (re || (_.f & N) !== 0), o = f.deps === null;
    Ee(f) && (u && (f.f |= N), Mt(f)), u && !o && en(f);
  }
  if (O?.has(e))
    return O.get(e);
  if ((e.f & X) !== 0)
...
function en(e) {
  if (e.deps !== null) {
    ...
    for (const t of e.deps)
      (t.reactions ??= []).push(e), (t.f & w) !== 0 && (t.f & N) === 0 && en(
        /** @type {Derived} */
        t
      );
  }
...
const nn = /* @__PURE__ */ new Set(), ze = /* @__PURE__ */ new Set();
function cr(e) {
  for (var t = 0; t < e.length; t++)
    nn.add(e[t]);
  for (var n of ze)
...
function Se(e) {
  ...
  r[f] || e.target, s !== t) {
    ...
    try {
      ...
      e.__root = t, delete e.currentTarget, T(a), j(d);
    }
  }
}
function hr(e) {
...
function rn(e, t) {
  ...
  return () => {
    if (m)
      return Ae(p, null), p;
    r === void 0 && (r = hr(s ? e : "<!>" + e), n || (r = /** @type {TemplateNode} */
    /* @__PURE__ */ _e(r)));
    var f = (
      /** @type {TemplateNode} */
...
function vr(e, t) {
  ...
  try {
    for (var s = /* @__PURE__ */ _e(n); s && (s.nodeType !== je || /** @type {Comment} */
    s.data !== _t); )
      s = /* @__PURE__ */ W(s);
    if (!s)
      throw ge;
...
`).some((l) => l.startsWith("https://svelte.dev/e/")))
      throw f;
    return f !== ge && console.warn("Failed to hydrate: ", f), t.recover === !1 && En(), Ke(), Wn(n), xe(!1), fn(e, t);
  } finally {
    xe(i), G(r);
  }
}
  ...
  var o = void 0, a = er(() => {
    ...
    return jn(
      ...
      (c) => {
        ...
        if (r && (i.$$events = r), m && Ae(
          /** @type {TemplateNode} */
          c,
          null
        ), o = e(c, i) || {}, m && (v.nodes.end = p, p === null || p.nodeType !== je || /** @type {Comment} */
        p.data !== pt))
          throw Qe(), ge;
        s && xt();
      }
      ...
      ze.delete(u), d !== n && d.parentNode?.removeChild(d);
    };
  });
  return We.set(o, a), o;
}
...
class wr {
  ...
  constructor(t) {
    ...
    const r = new Proxy(
      ...
      {
        get(s, f) {
          return A(n.get(f) ?? i(f, Reflect.get(s, f)));
        },
        has(s, f) {
          return f === mn ? !0 : (A(n.get(f) ?? i(f, Reflect.get(s, f))), Reflect.has(s, f));
        },
        set(s, f, l) {
    ...
    this.#t = (t.hydrate ? vr : fn)(t.component, {
      target: t.target,
      anchor: t.anchor,
      props: r,
      context: t.context,
      intro: t.intro ?? !1,
      recover: t.recover
    }), (!t?.props?.$$host || t.sync === !1) && Ct(), this.#e = r.$$events;
...
var Er = /* @__PURE__ */ rn("<pre> </pre> <!>", 1);
function xr(e, t) {
  Et(t, !0);
  let n = yr(t, "name", 7, "world");
  var i = {
    get name() {
      return n();
    },
  ...
  wt(s);
  var l = zn(s, 2);
  return $r(l, t, "default", {}), Ut(() => sn(f, `Hello ${n() ?? ""}!`)), st(e, r), xt(i);
}
customElements.define("my-element", on(xr, { name: {} }, ["default"], [], !0));
var Tr = /* @__PURE__ */ rn('<button class="svelte-dfcawr"> </button>');
const Sr = {
  hash: "svelte-dfcawr",
  code: `button.svelte-dfcawr {border-radius:8px;border:1px solid transparent;padding:0.6em 1.2em;font-size:1em;font-weight:500;font-family:inherit;background-color:#1a1a1a;cursor:pointer;transition:border-color 0.25s;border-color:#5f6195;}button.svelte-dfcawr:hover {border-color:#646cff;}button.svelte-dfcawr:focus,
  button.svelte-dfcawr:focus-visible {outline:4px auto -webkit-focus-ring-color;}

  @media (prefers-color-scheme: light) {:root {color:#213547;background-color:#ffffff;}button.svelte-dfcawr {background-color:#f9f9f9;border-color:#bbbce4;}
  }`
};
function kr(e) {
  gr(e, Sr);
  ...
  i.__click = n;
  var r = Bt(i);
  wt(i), Ut(() => sn(r, `Count is ${A(t) ?? ""}`)), st(e, i);
}
cr(["click"]);
customElements.define("my-counter", on(kr, {}, [], [], !0));
